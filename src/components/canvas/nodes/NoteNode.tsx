...
function NoteNodeComponent({ data, selected }: NodeProps) {
  const { label, description } = data as NoteNodeData;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2">
        <div className="w-6 h-6 rounded-md bg-yellow-400/10 flex items-center justify-center shrink-0 mt-0.5">
          <StickyNote className="w-3.5 h-3.5 text-yellow-400/70" />
        </div>
